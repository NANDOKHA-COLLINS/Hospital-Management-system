<marquee direction = "right"><h1>LIFECARE HOSPITALS..HEALTH IS OUR RESPONSIBILTY.</h1></marquee></h1>
<?php
session_start();
include("header.php");
...
if(isset($_POST[submit]))
{
	...
	else
	{
		...
		{
			echo "<h2>Appointment  successfully taken.. </h2>";
...
function validateform()
{
	...
	{
		alert("Insert The date of birth.");
...
<marquee direction = "up">WELCOME ALL</marquee></h1>